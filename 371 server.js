  ...
  try {
    ...
    <head>
        ...
        <style>
            ...
            /* CTA BUTTON STYLE - MOVED TO BOTTOM */
            .cta-btn { 
        ...
        <script>
            ...
            async function bootStore() {
                try {
                    ...
                    // RENDER CTA BUTTON AT BOTTOM
                    if(storeData.ctaUrl && storeData.ctaText) {
                        document.getElementById('cta-wrap').innerHTML = '<a href="'+storeData.ctaUrl+'" target="_blank" class="cta-btn">'+storeData.ctaText+'</a>';
                    }
